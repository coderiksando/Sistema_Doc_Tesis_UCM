  ...
  <div>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark font-weight-bold">Crear permisos</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-4 offset-4">
                                        <button class="btn btn-flat btn-info btnWidth" @click.prevent="setRegistrarPermisos" v-loading.fullscreen.lock="fullscreenLoading"
                                    >Registrar</button>
...
export default {
  ...
  methods:{
    ...
    setRegistrarPermisos(){
      ...
      var url = '/administracion/permisos/setRegistrarPermisos'
      axios.post(url, {
