  ...
  <div>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 text-dark font-weight-bold">Edición de documentos finalizados</h1>
          </div>
          <!-- /.col -->
        </div>
        <!-- /.row -->
            ...
            <div class="card card-info">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-10">
                    <h3 class="card-title">
                      Formulario de edición de documentos finalizados
                    </h3>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <el-select
                            v-model="fillEditarFIT.nIdEscuela"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <div class="input-group">
                            <el-input-number
                                v-if="fillEditarFIT.fidFinalizada"
                                style="width: 75%;"
                                v-model="fillEditarFIT.Nota"
                                size="large"
                                :min="1"
                                :precision="1"
                                :step="0.1"
                                :max="7"
                            ></el-input-number>
                            <input style="width: 40px; height: 40px; margin-left: auto; margin-right: 0;" type="checkbox" v-model="fillEditarFIT.fidFinalizada">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div v-if="fillEditarFIT.aComision.length > 0" class="col-md-7">
                    ...
                    <div class="col-md-6">
                      <div class="noPadNoMar col-md-12 form-group row">
                        <label v-if="fillEditarFIT.fidFinalizada" class="noPadNoMar col-md-12 col-form-label">Documento final (opcional)</label>
                        <label v-if="!fillEditarFIT.fidFinalizada" class="noPadNoMar col-md-12 col-form-label">Último documento (opcional)</label>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-9">
                        ...
                        v-model="fillEditarFIT.oProfExterno.p_externo">
                        </el-input>
                        <el-input
                        type="textarea"
                        :autosize="{ minRows: 1, maxRows: 5 }"
                        placeholder="Correo de profesor"
                        v-model="fillEditarFIT.oProfExterno.correo_p_externo">
                        </el-input>
                        <el-input
                        type="textarea"
                        :autosize="{ minRows: 1, maxRows: 5 }"
                        placeholder="Institución de profesor"
                        v-model="fillEditarFIT.oProfExterno.institucion_p_externo">
                        </el-input>
                    </div>
                    </div>
                </div>
  ...
  methods: {
    getTesisById() {
      ...
      axios.get(url, {
        ...
        .then((response) => {
            console.log('dato backend', response.data);
    ...
    setGuardarTesisfinalizada() {
      this.fullscreenLoading = true;
      var url = "/archivo/setEditarTesisfinalizada";
      ...
      axios.post(url, this.fillEditarFIT)
        .then((response) => {
    ...
    setIngresarNuevoAlumno() {
        ...
        if (!errorIngresoUser && !errorRegisterUser) {
            this.fillEditarFIT.cUsers.push(Vue.util.extend({}, this.newUser));
        }
        else {
            if (!errorRegisterUser) {
                ...
                this.mensajeError.push(
                    "Usuario seleccionado ya está enlistado en tu "+terminoTitulo+"."
                );
            }
            this.abrirModal();
        }
    ...
    terminoIngreso(ingreso) {
        if (ingreso.tesis && ingreso.acta && ingreso.const) {
            this.fullscreenLoading = false;
            this.$router.push({ name: "index.tesisfinal" });
            Swal.fire({
                icon: "success",
    ...
    corroboracionDatoOpcional () {
        if (!this.fillEditarFIT.nIdEscuela) {
            this.fillEditarFIT.nIdEscuela = this.listProfesores.find(profesor => profesor.id_user == this.fillEditarFIT.nIdPg).id_escuela;
        }
    ...
    getUsuarioVer(data) {
      ...
      if (this.fillEditarFIT.Nota !== null) this.fillEditarFIT.fidFinalizada = true;
